...
export const setupOrganizationSchema = z.object({
  ...
  contactEmail: z.string().email('Invalid email address').max(255).optional().nullable(),
  contactPhone: z.string().max(50).optional().nullable(),
  supportEmail: z.string().email('Invalid email address').max(255).optional().nullable(),
